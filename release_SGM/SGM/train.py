...
def main():
    ...
    parser.add_argument('--data_name', default='mscoco_split2014',
                        help='mscoco_split2014')
    ...
    parser.add_argument('--sg_file_name', type =str, default='_image_sg_by_MSDN.json',
    ...
    parser.add_argument('--caption_data_file_name', type=str, default='_caps.txt',
    ...
    train_loader, val_loader, opt.obj_vocab, opt.rel_vocab= data.get_loaders(
...
def validate(opt, val_loader, model):
    ...
    model.val_start()
    with torch.no_grad():
        img_embs, obj_nums, cap_embs, cap_lens, pred_embs, pred_nums, cap_rel_embs, cap_rel_nums = encode_data_with_predicate(
